        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-blue-grey-14">
              ...
              <div>Data Transakasi Pembelian dan Pemesanan</div>
            </q-banner>
          </div>
        </div>
      </div>
          ...
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td key="aksi" :props="props">
                <q-btn label="Detail" @click="openDetail(props.row)" color="primary" unelevated></q-btn>
                <q-btn :disable="props.row.status !== 1" label="Konfirmasi" @click="confirm(props.row._id)" class="q-ml-sm" color="green" unelevated></q-btn>
              </q-td>
            </q-tr>
          </template>
      </q-table>
    </q-card>
    <q-dialog v-model="detail" v-if="detail">
